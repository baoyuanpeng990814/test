...
<template>
  <div class="top-bg">
    <v-img
      ...
      top: 0;
      left: 0;"
      src="https://zhongfujiazheng.oss-cn-beijing.aliyuncs.com/learn/APK/%E5%B9%B3%E5%8F%B0%E5%9B%BE%E7%89%87/bg_login.png"
    ></v-img>
    <!-- 登录页面 -->
    <div class="login_frame">
      <v-form v-model="valid" v-if="isLogin">
        <div class="font-303232-1-2 i-center margint-1">
          秦皇岛家政服务业培训平台
        </div>
        ...
        <div class="i-column">
          ...
          <div class="i-row i-align-center">
            ...
            <v-img
              ...
              :src="
                typePwd
                  ? require('../images/icon/icon_watch.png')
                  : require('../images/icon/icon_unwatch.png')
              "
              @click="change()"
            ></v-img>
          </div>
          ...
          <v-btn @click="login" block dark elevation="2" class="btn_login"
            >登陆</v-btn
          >
          ...
          <v-row>
            <v-col cols="12" md="4">
              ...
              <v-text-field
                ...
                :rules="rule_register.rePassword"
                label="确认密码"
                required
              >
              </v-text-field>
...
export default {
  ...
  methods: {
    userRegister() {
      ...
      this.$store
        .dispatch('userRegister', this.register)
        .then((res) => {
