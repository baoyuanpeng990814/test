    ...
    <div class="exercise_bg">
      <v-app-bar flat style="background: transparent; ">
        <v-btn @click="goBack" icon>
          <v-img
            src="../../images/icon/icon_back_white.png"
            height="18px"
            contain
          ></v-img>
        </v-btn>
        <div class="tool_title" style="color: white; margin: auto;">
          题库练习
        </div>
      ...
      <div v-if="questions[questionIndex].questionsType === 1">
        <div
          v-for="l in questions[questionIndex].lOptionList"
          :key="l.optionNum"
        >
          <div
            class="i-row "
            ...
            @click="
              answerClick(l.optionNum, questions[questionIndex].questionsAnswer)
            "
          >
            <div
              :class="getAnswerStyle(l.optionNum)"
              v-html="l.optionContent"
              :value="l.optionNum"
            ></div>
            <img
              :src="getAnswerSrc(l.optionNum)"
              v-show="getAnswerSrc(l.optionNum)"
              width="21px"
              height="21px"
              style="position: absolute; right: 10%; top: 2.6rem;"
            />
          </div>
        </div>
      </div>
      ...
      <div v-if="questions[questionIndex].questionsType === 3">
        ...
        >
          <div
            ...
            "
          >
            <div :class="getAnswerStyle(l.optionNum)" :value="l.optionNum">
        ...
        <v-card>
          <div class="question_list" v-if="datadetail.examQuestions != null">
            <div v-if="datadetail.examQuestions.radio != null">
              ...
              <ul>
                <li
                  v-for="q in datadetail.examQuestions.radio.length"
            ...
            <div v-if="datadetail.examQuestions.check != null">
              ...
              <ul>
                <li
                  v-for="q in datadetail.examQuestions.check.length"
            ...
            <div v-if="datadetail.examQuestions.judge != null">
              ...
              <ul>
                <li
                  v-for="q in datadetail.examQuestions.judge.length"
        ...
        .then((res) => {
          if (res.data.state == 200) {
            ...
            if (this.datadetail.examQuestions.radio != null) {
              for (
                var i = 0;
                i < this.datadetail.examQuestions.radio.length;
                i++
              ) {
            ...
            if (this.datadetail.examQuestions.check != null) {
              for (
                var i = 0;
                i < this.datadetail.examQuestions.check.length;
                i++
              ) {
            ...
            if (this.datadetail.examQuestions.judge != null) {
              for (
                var i = 0;
                i < this.datadetail.examQuestions.judge.length;
                i++
              ) {
