<template>
  <div class="selection_body">
    ...
    <div class="head_menu">
      <ul>
        <li v-for="t in themes.length">
          <el-button type="text" @click="turnToList(t-1)">{{themes[t-1].themeName}}</el-button>

          <div class="incidental">
            <div class="option" v-for="ct in themes[t-1].chilLTheme">
              <el-button @click="turnToList(t-1,ct.themeId)" type="text">{{ct.themeName}}</el-button>
            </div>
          </div>
        </li>
      </ul>
    ...
    <div class="selection_content">
      <el-container>
        <el-main>
          <div v-for="t in themes.length">
            <el-card>
              <div slot="header" class="clearfix">
                <span>{{themes[t-1].themeName}}</span>
                <el-button @click="turnToList(t-1)" style="float: right; padding: 3px 0" type="text">更多</el-button>
              </div>
              <div class="selection_page">
                <el-row>
                  <el-col :span="12" v-for="s in sections[t-1]">
                    <!-- {{s.courseName}}-->
          ...
          <el-button @click="turnToList()" class="load_more">点击加载更多</el-button>
...
<script>
  export default {
    ...
    methods: {
      ...
      turnToList(index, index2) { //转到list
      ...
      async getSections(id, index) { //获取课程主题
