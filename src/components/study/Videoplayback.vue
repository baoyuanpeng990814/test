...
<template>
  <div id="app">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: '/mystudy' }"
        >我的学习</el-breadcrumb-item
      >
      <el-breadcrumb-item :to="{ path: '/Videoplayback' }"
        >我的视频</el-breadcrumb-item
      >
      <!--<el-breadcrumb-item>我的考试</el-breadcrumb-item>
            <el-breadcrumb-item>我的错题</el-breadcrumb-item>-->
      <el-breadcrumb-item
        style="float:right"
        v-if="this.userList[0] && this.userList[0].role_name"
      >
        <b
          ><u>你好！{{ this.userList[0].role_name }} </u></b
        ></el-breadcrumb-item
      >
    </el-breadcrumb>
        ...
        >
          <el-submenu index="1">
            ...
            <el-menu-item
              ...
              v-for="(item, index) in videoList.lChapters"
              :key="index"
              style="color:black font-size:28px text-align:center"
            >
              <span
                slot="title"
                @click="videoClick(item.lCourseware.resourcesLink)"
                v-clickDown="index"
                >{{ item.chapterName }}</span
              >
            </el-menu-item>
          </el-submenu>
          <!-- <el-submenu index="1">
