      ...
      <div slot="header" class="clearfix">
        ...
        <el-row class="search_form">
          ...
          <el-col :span="11">
            ...
            <el-button icon="el-icon-plus" @click="publish" type="primary">发布考次</el-button>
          </el-col>
        </el-row>
        <div class="space"></div>
          ...
          <el-main class="list_body">
            ...
            <el-table height=" calc(100vh - 400px) " ref="multipleTable" :data="tableData" tooltip-effect="dark"
              ...
              <el-table-column prop="releaseTime" label="发布时间">
                <template slot-scope="scope">{{ scope.row.releaseTime |truncateDate }}</template>
              </el-table-column>
              ...
              <el-table-column prop="competitionState" label="竞赛阶段状态">
                <template slot-scope="scope">{{ scope.row.competitionState |transfermContestState }}</template>
              </el-table-column>
              <el-table-column fixed="right" label="操作">
                <template slot-scope="scope">
                  <el-button @click="editDetail(scope.row)" type="text" size="small">编辑</el-button>
                  <el-button @click="deleteRow(scope.row)" type="text" size="small">删除</el-button>
                  <el-button @click="showRank(scope.row.competitionId)" type="text" size="small">查看排行</el-button>
                  <el-button @click="addNews(scope.row.competitionId)" type="text" size="small">添加新闻</el-button>
                  <el-button @click="showOperation(scope.row.competitionId)" type="text" size="small" v-show="scope.row.competitionType!=1">查看实操</el-button>
                </template>
              </el-table-column>
            </el-table>
