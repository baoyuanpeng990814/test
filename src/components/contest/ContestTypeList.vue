        ...
        <el-container>
          ...
          <el-main class="list_body">
            ...
            >
              ...
              <!-- <el-table-column prop="contestId" label="序号">
              </el-table-column> -->
              <el-table-column
                prop="competitionSortId"
                label="分类id"
                align="center"
              >
              </el-table-column>
              <el-table-column
                prop="competitionSortName"
                label="分类名称"
                align="center"
              >
              </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleNodeClick(data) {
      this.queryInfo.competitionSortName = data.competitionSortName
      this.currentNode = data.competitionSortId

      // if (data.parentNode == 0) this.queryInfo.contestSortId = null
      this.getDataList()
    },
    async getDataTree() {
