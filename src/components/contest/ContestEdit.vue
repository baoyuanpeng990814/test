            ...
            <el-main>
              <el-form :model="dataDetail" :rules="rules" ref="dataDetail" label-width="100px"
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="封面" prop="competitionCover">
                      <el-input v-model="dataDetail.competitionCover"></el-input>
                      <el-upload :on-success="handleAvatarSuccess" class=" mt15 avatar-uploader" :action="uploadUrl"
                        :show-file-list="false">
                        <img v-if="dataDetail.competitionCover" :src="dataDetail.competitionCover" class="avatar">
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="竞赛类型" prop="competitionType">
                      <el-radio v-model="dataDetail.competitionType" label="1">1理论</el-radio>
                      <el-radio v-model="dataDetail.competitionType" label="2">2实操 </el-radio>
                      <el-radio v-model="dataDetail.competitionType" label="3">3理论+实操</el-radio>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="所属分类" prop="competitionSort">
                      <el-input v-model="twin.competitionSortName" @focus="showOd2=true" :readonly="true"></el-input>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="发布对象分类" prop="competitionTarget">
                      <el-radio v-model="competitionTarget.competitionTargetType	" label="0">机构</el-radio>
                      <el-radio v-model="competitionTarget.competitionTargetType	" label="1">分组</el-radio>
                      <el-radio v-model="competitionTarget.competitionTargetType	" label="2">用户</el-radio>
                      <el-radio v-model="competitionTarget.competitionTargetType	" label="3">职业</el-radio>
                    </el-form-item>
                  </el-col>
                </el-row>
                <!-- 当发布对象类型是0是弹出发布对象的接口-->
                <el-row v-show="competitionTarget.competitionTargetType	 == '0'">
                  <el-col :span="24">
                    <div>
                      <el-form-item label="发布机构对象" prop="competitionTarget">
                        <el-input v-model="twin.organizationName" @focus="showOd=true" suffix-icon="el-icon-search"
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="分数定义" prop="fractionType">
                      <el-radio v-model="dataDetail.fractionType" label="1">1使用题库试题分数</el-radio>
                      <el-radio v-model="dataDetail.fractionType" label="2">2指定题型分数</el-radio>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="竞赛状态" prop="competitionState">
                      <el-radio v-model="dataDetail.competitionState" label="1">1答题阶段</el-radio>
                      <el-radio v-model="dataDetail.competitionState" label="2">2实操阶段</el-radio>
                      <el-radio v-model="dataDetail.competitionState" label="3">3专家评分阶段</el-radio>
                      <el-radio v-model="dataDetail.competitionState" label="4">4结束</el-radio>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="竞赛声明" prop="competitionExplain">
                      <quill-editor ref="text" v-model="dataDetail.competitionExplain" class="myQuillEditor" />
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="参赛次数限制" prop="competitionFrequency">
                      <el-input-number v-model="dataDetail.competitionFrequency"></el-input-number>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="离开页面次数" prop="leavePage">
                      <el-input-number v-model="dataDetail.leavePage"></el-input-number>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="发布时间" prop="releaseTime">
                      <el-date-picker v-model="dataDetail.releaseTime" type="datetime" placeholder="发布时间">
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="出题方式" prop="assignTopic">
                      <el-radio v-model="dataDetail.assignTopic" label="1">固定试卷</el-radio>
                      <el-radio v-model="dataDetail.assignTopic" label="2">随机试卷</el-radio>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="答题开始时间" prop="timingStartTime">
                      <el-date-picker v-model="dataDetail.timingStartTime" type="datetime" placeholder="选择日期时间">
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="答题结束时间" prop="timingEndTime">
                      <el-date-picker v-model="dataDetail.timingEndTime" type="datetime" placeholder="选择日期时间">
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="实操开始时间" prop="operationStartTime">
                      <el-date-picker v-model="dataDetail.operationStartTime" type="datetime" placeholder="选择日期时间">
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="实操结束时间" prop="operationEndTime">
                      <el-date-picker v-model="dataDetail.operationEndTime" type="datetime" placeholder="选择日期时间">
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="专家打分开始时间" prop="expertStartTime">
                      <el-date-picker v-model="dataDetail.expertStartTime" type="datetime" placeholder="选择日期时间">
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="专家打分结束时间" prop="expertEndTime">
                      <el-date-picker v-model="dataDetail.expertEndTime" type="datetime" placeholder="选择日期时间">
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
                </el-row>
        ...
        <el-main>
          <el-form :model="strategydetail" :rules="sdrules" ref="strategydetail" label-width="100px"
            ...
            <el-row>
              <el-col :span="24">
                ...
                <el-form-item>
                  ...
                  <el-table :data="competitionQuestionList" border style="width: 100%">
                    <el-table-column prop="competitionQuestionId" label="抽题序号">
                    </el-table-column>
                    <el-table-column prop="competitionTypeId" label="题型">

                      <template slot-scope="scope">{{ scope.row.competitionTypeId | transfermType }}</template>
                    </el-table-column>
                    <el-table-column prop="number" label="数量">
                    </el-table-column>
                    <el-table-column fixed="right" label="操作" width="100">
                      <template slot-scope="scope">
                        <el-button type="text" size="medium" @click="delStrategy(scope.row.competitionQuestionId)">删除
                        </el-button>
                      </template>
                    </el-table-column>
                  </el-table>
            ...
            <div class="question_type_list" v-if="strategydetail.questionsSortId!=0">
              <el-row v-for="l in strategydetail.competitionQuestionList">
                <el-col :span="24">
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      for (var i = 0; i < this.strategydetail.competitionQuestionList.length; i++) {
        this.strategydetail.competitionQuestionList[i].competitionId = this.dataDetail.competitionId
      }
      /*判断传参 */
    ...
    methods: {
      ...
      async getStrategy() { //获取出题策略
        const {
          data: res
        } = await this.$http.get("/manager/competition/eqinfo?id=" + this.dataDetail.competitionId)
        if (res.state !== 200) {
          return this.$message.error(res.msg)
        } else {
      ...
      async delStrategy(id) {
        const {
          data: res
        } = await this.$http.post("/manager/competition/eqdel", {
      ...
      async addStrategy() {
        ...
        const {
          data: res
        } = await this.$http.post("/manager/competition/eqadd", add)
        if (res.state !== 200) {
          return this.$message.error(res.msg)
        } else {
      ...
      async getQuestionCateNum(old) { //获取每种题型各有几道题
        var url = "/manager/competition/queryNum?questionsSortId=" +
        ...
        if (res.state !== 200) {
          ...
          for (var i = 0; i < res.data.length; i++) {
            this.strategydetail.competitionQuestionList[i].competitionTypeId = res.data[i].questionsType
            this.strategydetail.competitionQuestionList[i].difficulty = this.strategydetail.difficulty
            this.strategydetail.competitionQuestionList[i].knowledge = this.strategydetail.knowledge
            this.strategydetail.competitionQuestionList[i].questionsSortId = this.strategydetail.questionsSortId
            this.strategydetail.competitionQuestionList[i].competitionId = this.strategydetail.competitionId
          }
          this.$forceUpdate()
      ...
      async submitCreation() {
        const {
          data: res
        } = await this.$http.post("/manager/competition/edit", this.dataDetail)
        if (res.state !== 200) {
          return this.$message.error(res.msg)
        } else {
