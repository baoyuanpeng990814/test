        ...
        <v-card class="vc " v-for="d in datas">
          ...
          >
            ...
            <div class="i-column marginl-1 i-with100">
              ...
              <span class="font-A9ADAD-0-9 margint-0-5"
                >答题时间:{{ d.timingStartTime }} 分钟</span
              >
              <span class="font-A9ADAD-0-9 margint-0-5"
                >结束时间:{{ d.failureTime | splitTime }}</span
              >
