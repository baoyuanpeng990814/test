<template>
  <div id="app">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: '/contestcreate' }">竞赛添加考次</el-breadcrumb-item>
    </el-breadcrumb>
              ...
              <el-row>
                <el-col :span="24">
                  <el-form-item label="发布时间" prop="releaseTime">
                    <el-date-picker v-model="dataDetail.releaseTime" type="datetime"
                      value-format="yyyy-MM-dd HH:mm:ss" placeholder="发布时间">
                    </el-date-picker>
                  </el-form-item>
                </el-col>
              </el-row>
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="实操开始时间" prop="operationStartTime">
                      <el-date-picker v-model="dataDetail.operationStartTime" type="datetime"
                        value-format="yyyy-MM-dd HH:mm:ss" placeholder="选择日期时间">
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="实操结束时间" prop="operationEndTime">
                      <el-date-picker v-model="dataDetail.operationEndTime" type="datetime"
                        value-format="yyyy-MM-dd HH:mm:ss" placeholder="选择日期时间">
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="专家打分开始时间" prop="expertStartTime">
                      <el-date-picker v-model="dataDetail.expertStartTime" type="datetime"
                        value-format="yyyy-MM-dd HH:mm:ss" placeholder="选择日期时间">
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="专家打分结束时间" prop="expertEndTime">
                      <el-date-picker v-model="dataDetail.expertEndTime" type="datetime"
                        value-format="yyyy-MM-dd HH:mm:ss" placeholder="选择日期时间">
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
...
<script>
  ...
  export default {
    ...
    created() {
      this.dataDetail.competitionSortId = this.$route.query.parent
    },
    methods: {
      /* 封面路径显示*/
      ...
      getOd2(val) {
        this.dataDetail.competitionSortId = val.contestSortId
      ...
      async submitCreation() {
        ...
        const {
          data: res
        } = await this.$http.post("/manager/competition/add", this.dataDetail)
        if (res.state !== 200) {
