<template>
  <div id="app">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: '/messagelist' }"
        >消息管理</el-breadcrumb-item
      >
    </el-breadcrumb>
        ...
        <el-row class="search_form">
          <el-form class="demo-ruleForm login_form" label-width="auto">
            ...
            <el-col :span="19" style="text-align: right;">
              ...
              <el-button icon="el-icon-plus" @click="addMessage" type="primary"
                >添加</el-button
              >
            </el-col>
          </el-form>
        ...
        <el-container>
          <el-main class="list_body">
            ...
            >
              ...
              <el-table-column prop="messageId" label="序号" align="center">
              </el-table-column>
              ...
              <el-table-column prop="messageState" label="状态" align="center">
                <template slot-scope="scope">{{
                  scope.row.messageState | transformState
                }}</template>
              </el-table-column>
              <el-table-column
                prop="messageType"
              ...
              >
                <template slot-scope="scope">{{
                  scope.row.messageType | transformType
                }}</template>
              </el-table-column>
              <el-table-column
                prop="createTime"
              ...
              <el-table-column fixed="right" label="操作" align="center">
                <template slot-scope="scope">
                  ...
                  >
                  <el-button
                    @click="releaseMessage(scope.row)"
                    type="text"
                    size="small"
                    >发布</el-button
                  >
...
export default {
  ...
  methods: {
    ...
    async RemoveMessage() {
      const { data: res } = await this.$http.post('/manager/message/del', {
