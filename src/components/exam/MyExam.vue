<template>
  <div id="app">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: '/myexam' }"
    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <el-radio-group v-model="query.examSortId">
          ...
          <el-radio-button
            v-for="e in examSorts"
            :label="e.examSortId"
            :key="e.id"
            >{{ e.examSortName }}</el-radio-button
          >
        </el-radio-group>
        <div class="space"></div>
      ...
      <div class="text item exam_list">
        <div v-for="d in datas" :key="d.id">
          ...
          <div>
            ...
            <div v-else>
              答题时间:{{ d.timingStartTime }}分钟&nbsp;&nbsp;截止时间:{{
                d.failureTime | truncateTime
              }}
            </div>
          </div>
          <div>
            <el-button @click="enrollExam(d)" type="primary"
              >参加考试</el-button
            >
          </div>
          <p class="cb"></p>
