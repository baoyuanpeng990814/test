          ...
          <el-form class="demo-ruleForm login_form" label-width="auto">
            ...
            <el-col :span="19" style="text-align: right;">
              ...
              <el-button
                ...
                >重置</el-button
              >
              <el-button icon="el-icon-plus" @click="addcarousel" type="primary"
                >添加</el-button
              >
            </el-col>
          </el-form>
        ...
        <el-container>
          ...
          <el-main class="list_body">
            ...
            >
              ...
              <el-table-column prop="rotateId" label="序号" align="center">
              </el-table-column>
              <el-table-column prop="rotateTop" label="发布状态" align="center">
                <template slot-scope="scope">{{
                  scope.row.rotateTop | transformState
                }}</template>
              </el-table-column>
              <el-table-column
                prop="jumpUrl"
              ...
              >
                <template slot-scope="scope">{{
                  scope.row.rotateState | transState
                }}</template>
              </el-table-column>
              <el-table-column prop="createUser" label="作者" align="center">
              </el-table-column>
              <el-table-column
                prop="createTime"
                label="发布时间"
...
export default {
  ...
  methods: {
    ...
    async Removecarousel() {
      const { data: res } = await this.$http.post('/manager/rotate/del', {
