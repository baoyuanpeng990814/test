              ...
              >
                <el-row>
                  ...
                  <el-form-item label="图片路径" prop="picturesUrl">
                    ...
                    >
                      <img
                        v-if="carouseldetail.picturesUrl"
                        :src="carouseldetail.picturesUrl"
                        class="avatar"
                      />
                      <i
                        v-else
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="轮播图类型" prop="rotateTop">
                      <el-radio v-model="carouseldetail.rotateState" label="1"
                        >PC端</el-radio
                      >
                      <el-radio v-model="carouseldetail.rotateState" label="2"
                        >移动端</el-radio
                      >
                    </el-form-item>
                  </el-col>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="状态" prop="rotateTop">
                      <el-radio v-model="carouseldetail.rotateTop" label="1"
                        >已发布</el-radio
                      >
                      <el-radio v-model="carouseldetail.rotateTop" label="2"
                        >未发布</el-radio
                      >
                    </el-form-item>
                  </el-col>
