          ...
          <el-form class="demo-ruleForm login_form" label-width="auto">
            ...
            <el-col :span="19" style="text-align: right;">
              ...
              <el-button
                ...
                >重置</el-button
              >
              <el-button icon="el-icon-plus" @click="addnews" type="primary"
                >添加</el-button
              >
            </el-col>
          </el-form>
        ...
        <el-container>
          ...
          <el-main class="list_body">
            ...
            >
              ...
              <el-table-column prop="newId" label="序号" align='center'>
              </el-table-column>
              <el-table-column prop="releaseState" label="发布状态" align='center'>
...
export default {
  ...
  methods: {
    ...
    async RemoveNews() {
      const { data: res } = await this.$http.post('/manager/new/del', {
