                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="发布对象" prop="competitionUser">
                      <el-input v-model="newsdetail.competitionUser" @focus="dialogUserList=true"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-form-item label="服务类型" prop="lExamTarget">
                    <el-input v-model="twin.serviceName" @focus="showOp=true" suffix-icon="el-icon-search"
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="内容" prop="content">
                      <quill-editor ref="text" v-model="newsdetail.content" class="myQuillEditor" />
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="排序" prop="competitionSeq">
                      <el-input-number v-model="newsdetail.competitionSeq"></el-input-number>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="状态" prop="competitionState">
                      <el-radio v-model="newsdetail.competitionState" label="1">已上架</el-radio>
                      <el-radio v-model="newsdetail.competitionState" label="0">未上架</el-radio>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
    ...
    <el-dialog title="" :visible.sync="dialogUserList" width="80%">
      ...
      <el-container>
        ...
        <el-main class="list_body">
          <el-table height=" calc(100vh - 350px) " ref="multipleTable" :data="userTableData" tooltip-effect="dark"
          ...
          <el-pagination @size-change="handleSizeChange2" @current-change="handleCurrentChange2"
            :page-size="queryInfo2.rows" layout="total, prev, pager, next, jumper" :total="userTotal">
          </el-pagination>
        </el-main>
      </el-container>

    </el-dialog>
    <CompetitionTypePanel :show="showOp" @choose="getOd" @turnOff="(e) => showOp=e"></CompetitionTypePanel>
  </div>
</template>
<script>
  import {
  ...
  export default {
    ...
    created() {
      ...
      this.twin.serviceName = this.newsdetail.competitionSort
