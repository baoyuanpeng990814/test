        ...
        <el-container>
          ...
          <el-main class="list_body">
            ...
            >
              ...
              <el-table-column prop="dictTypeId" label="序号" align="center">
              </el-table-column>
              <el-table-column
                prop="dictTypeName"
                label="字典类型名称"
              ...
              <el-table-column prop="dictSys" label="归属系统" align="center">
              </el-table-column>

              <el-table-column fixed="right" label="操作" align="center">
                <template slot-scope="scope">
                  <el-button
                    @click="editDicTypeFn(scope.row)"
                    type="text"
                    size="small"
                    >编辑</el-button
                  >
                  <el-button
                    class="red"
                    @click="deleteDicTypeFn(scope.row)"
                    type="text"
                    size="small"
                    >删除</el-button
                  >
...
export default {
  ...
  methods: {
    ...
    async RemoveType() {
      const { data: res } = await this.$http.post('/manager/dtyp/del', {
    ...
    editDicTypeFn(row) {
      this.$router.push({
        ...
        query: {
          row: row,
          edit: true,
          dicTypeTreeData: this.tableData
        }
      })
    },
    deleteDicTypeFn(row) {
