      ...
      <el-card>
        <div slot="header" class="clearfix">
          <el-row>
            ...
            <el-col :span="4">
              <el-button icon="el-icon-arrow-left" @click="$router.push('/questionlist')">返回</el-button>
            </el-col>
          </el-row>
        </div>
              ...
              <el-form :model="datadetail" :rules="rules" ref="datadetail" label-width="100px"
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="*题型" prop="questionsType">
                      <el-input v-model="twin.questionsType" @focus="showQp = true" :readonly="true"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="分数" prop="questionsFraction">
                      <el-input-number v-model="datadetail.questionsFraction"></el-input-number>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="难度" prop="questionsDifficulty">
                      <el-select v-model="datadetail.questionsDifficulty" placeholder="请选择">
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="*分类" prop="questionsSort">
                      <el-input v-model="twin.questionsSort" @focus="showQc = true" :readonly="true"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="序号" prop="questionsSeq">
                      <el-input-number v-model="datadetail.questionsSeq"></el-input-number>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="试题内容" prop="questionsContent">
                      <quill-editor ref="text" v-model="datadetail.questionsContent" class="myQuillEditor" />
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="选项数">
                      <el-input-number v-model="optionslength"></el-input-number>
                    </el-form-item>
                  </el-col>
                </el-row>

                <el-row v-for="o in datadetail.lOptionList.length">
                  <el-col :span="3.5">
                    <el-form-item :label="datadetail.lOptionList[o-1].optionNum">
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="题解" prop="questionsExplain">
                      <el-input type="textarea" :rows="4" v-model="datadetail.questionsExplain"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="20" :offset="4">
                    <el-button type="primary" @click="submitCreation(false)">保存</el-button>
                    <el-button type="primary" @click="submitCreation(true)">保存并添加下一题</el-button>
                  </el-col>
                </el-row>
...
<script>
  ...
  export default {
    ...
    created() {
      this.datadetail.questionsSortId = this.$route.query.parent
    },
    methods: {
      chooseQc(val) {
      ...
      async submitCreation(next) {
        ...
        for (var i = 0; i < this.answers.length; i++) {
          if (this.answers[i]) {
            this.datadetail.questionsAnswer += (i + 1 + 9).toString(36).toUpperCase() + ',' // 把数字转化成字母
          }
        }
        ...
        const {
          data: res
        } = await this.$http.post('/manager/questions/add', this.datadetail)
        if (res.state !== 200) {
          ...
          if (next) {
            this.$router.push({
              path: '/questioncreate',
              query: {
                parent: this.datadetail.questionsSortId
