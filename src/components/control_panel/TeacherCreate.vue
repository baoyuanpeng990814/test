<template>
  <div id="app">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: '/teachercreate' }">编辑讲师</el-breadcrumb-item>
    </el-breadcrumb>
          ...
          <el-form :model="teacherdetail" :rules="rules" ref="teacherdetail" label-width="100px"
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="出生日" prop="teacherBirthTime">
                  <el-date-picker value-format="yyyy-MM-dd" type="date" v-model="teacherdetail.teacherBirthTime">
                  </el-date-picker>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="20" :offset="4">
                <el-button type="primary" @click="submitCreationReady()">提交</el-button>
              </el-col>
            </el-row>
          </el-form>
            </el-main>
  ...
  export default {
    ...
    methods: {
      ...
      async submitCreation() {
        ...
        const {
          data: res
        } = await this.$http.post("/manager/teacher/add", this.teacherdetail)
        if (res.state !== 200) {
