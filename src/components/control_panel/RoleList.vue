<template>
  <div id="app">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: '/rolelist' }"
        ...
        <el-row class="search_form">
          <el-form class="demo-ruleForm login_form" label-width="auto">
            ...
            <el-col :span="14" style="text-align: right;">
              ...
              <el-button icon="el-icon-plus" @click="addRole" type="primary"
                >添加</el-button
              >
            </el-col>
          </el-form>
...
export default {
  ...
  methods: {
    ...
    async RemoveRole() {
      const { data: res } = await this.$http.post('/manager/role/del', {
        roleId: this.supposeDelete.roleId
      })
      if (res.state !== 200) {
