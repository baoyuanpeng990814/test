<template>
  <div id="app">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: '/examcreate' }">添加考次</el-breadcrumb-item>
    </el-breadcrumb>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="分类" prop="type">
                      ...
                      <el-radio v-model="examDetail.type" label="2">模拟</el-radio>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
  ...
  export default {
    ...
    methods: {
      ...
      async submitCreation() {
        ...
        const {
          data: res
        } = await this.$http.post("/manager/exam/add", this.examDetail)
        if (res.state !== 200) {
