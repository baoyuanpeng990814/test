<template>
  <div id="app">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      >
      <el-breadcrumb-item :to="{ path: '/coursecreate' }"
        >创建课件</el-breadcrumb-item
      >
    </el-breadcrumb>
          ...
          <el-container>
            <el-main>
              ...
              >
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="课件名称" prop="coursewareName">
                      <el-input
                        v-model="coursedetail.coursewareName"
                      ></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="课件分类" prop="coursewareTypeId">
                      <el-input
                        v-model="coursedetail.coursewareTypeId"
