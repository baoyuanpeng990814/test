<template>
  <div id="app">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: '/coursecreate' }">创建课件</el-breadcrumb-item>
    </el-breadcrumb>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="分类" prop="coursewareTypeId">
                      <el-input v-model="coursedetail.coursewareTypeId" @focus="typeDialog=true"
                        suffix-icon="el-icon-search" :readonly="true"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
