      ...
      <div slot="header" class="clearfix">
          ...
          <el-form class="demo-ruleForm login_form" label-width="auto">
            <el-col :span="5">
              <el-form-item label="课件名称">
                <el-input v-model="queryInfo.coursewareName" placeholder="课件名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="5">
              <el-form-item label="主讲人">
                <el-select v-model="filterPara.teacherId" placeholder="请选择">
                  <el-option v-for="item in teachers" :key="item.teacherId" :label="item.teacherName"
        ...
        <el-row class="buttons">
          ...
          <el-col :span="24" :offset="0">
            ...
            <el-button icon="el-icon-plus" @click="addCourse" type="primary">添加</el-button>
          </el-col>
        </el-row>
      </div>
      <div>
