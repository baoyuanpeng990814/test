          ...
          <el-form class="demo-ruleForm login_form" label-width="auto">
            ...
            <el-col :span="5">
              <el-form-item label="题型">
                <el-input v-model="typeName" placeholder="题型" @focus="showQp=true" :readonly="true">
                </el-input>
              </el-form-item>
            </el-col>
            <el-col :span="5">
              <el-form-item label="试题内容">
                <el-input v-model="queryInfo.questionsContent" placeholder="试题内容"></el-input>
              </el-form-item>
            </el-col>
          </el-form>
        </el-row>
        ...
        <el-container>
          ...
          <el-main class="list_body">
            ...
            <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :page-sizes="[1, 2, 5, 8]"
              :page-size="queryInfo.rows" layout="total,  prev, pager, next, jumper" :total="total" ref="pagination"
...
<script>
  ...
  export default {
    ...
    created() {
      if (localStorage.getItem('queryInfo')) {
        console.log('0000000')
      ...
      console.log('生命周期开始a', this.queryInfo)

      /* var a = localStorage.getItem("queryInfo");
    ...
    methods: {
      ...
      handleNodeClick(data) {
        ...
        this.queryInfo.questionsContent = ''
      ...
      editDetail(row) {
        ...
        console.log('2222222222222222222222222222222222228888')
