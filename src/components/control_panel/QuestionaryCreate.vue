<template>
  <div id="app">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      >
      <el-breadcrumb-item :to="{ path: '/questionarycreate' }"
        >编辑问卷</el-breadcrumb-item
      >
    </el-breadcrumb>
        ...
        <div slot="header" class="clearfix">
          <el-row>
            <el-col :span="20"
              >编辑问卷 &nbsp;&nbsp;
              <el-button
                v-if="dataDetail.examineId != null"
                @click="showId = true"
                >编辑问题</el-button
              >
            </el-col>
              ...
              >
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="封面" prop="examineCover">
                      ...
                      >
                        <img
                          v-if="dataDetail.examineCover"
                          :src="dataDetail.examineCover"
                          class="avatar"
                        />
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="次数限制" prop="examFrequency">
                      <el-input-number
                        v-model="dataDetail.examineFrequency"
                      ></el-input-number>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col style="text-align: center;">
                    <el-button type="primary" @click="quesNaireAddFn()"
                      >提交</el-button
                    >
                  </el-col>
                </el-row>
    ...
    <Inquiry
      :show="showId"
      :examineId="dataDetail.examineId"
      @choose="getOd"
      @turnOff="e => (showId = e)"
    ></Inquiry>
  </div>
...
export default {
  ...
  methods: {
    async quesNaireAddFn() {
      if (
        this.dataDetail.examineId != null &&
        this.dataDetail.examineId !== '' &&
        this.dataDetail.examineId !== 0
      ) {
        const { data: res } = await this.$http.post(
          '/manager/examine/edit',
          this.dataDetail
        )
        if (res.state !== 200) {
