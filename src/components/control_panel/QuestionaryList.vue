      ...
      <div slot="header" class="clearfix">
        ...
        <el-row class="buttons">
          ...
          <el-col :span="24" :offset="0">
            ...
            <el-button icon="el-icon-plus" @click="publish(1)" type="primary">发布</el-button>
            <el-button icon="el-icon-plus" @click="publish(2)" type="primary">归档</el-button>
          </el-col>
        </el-row>
        <div class="space"></div>
        <el-row class="buttons">
          <el-col :span="24" :offset="0">
            <el-button icon="el-icon-plus" @click="addNode" type="primary">添加分类</el-button>
        ...
        <el-container>
          ...
          <el-main class="list_body">
            ...
            <el-table height=" calc(100vh - 350px) " ref="multipleTable" :data="tableData" tooltip-effect="dark"
              ...
              <el-table-column prop="examineId" label="序号" width="60">
              </el-table-column>
              <el-table-column prop="examineNum" label="编号" width="120">
              </el-table-column>
              <el-table-column prop="examineName" label="名称" width="120">
              </el-table-column>
