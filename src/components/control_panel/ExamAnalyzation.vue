    ...
    <el-card class="list_card">
      ...
      <div>
        <el-table height=" calc(100vh - 350px) " ref="multipleTable" :data="tableData" tooltip-effect="dark"
          ...
          <el-table-column prop="organizationName" label="主办单位" width="120">
          </el-table-column>
          <el-table-column prop="examSortName" label="所属分类" width="90">
          </el-table-column>
          <el-table-column prop="failureTime" label="失效时间" width="120">
            <template slot-scope="scope">{{ scope.row.failureTime |transfermDate }}</template>
          </el-table-column>
          <el-table-column prop="enrollNum" label="应考" width="60">
          </el-table-column>
          <el-table-column prop="examNum" label="实考" width="60">
          </el-table-column>
          <el-table-column prop="completeNum" label="通过" width="60">
          </el-table-column>
          <el-table-column prop="average" label="平均分" width="90">
          </el-table-column>
          <el-table-column prop="maxScores" label="最高分" width="90">
          </el-table-column>
          <el-table-column prop="minScores" label="最低分" width="90">
          </el-table-column>
