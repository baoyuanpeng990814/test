<template>
  <div id="app">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: '/questiontypelist' }">题型管理</el-breadcrumb-item>
      <el-breadcrumb-item :to="{ path: '/questiontypecreate' }">创建题型</el-breadcrumb-item>
    </el-breadcrumb>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="题型名称" prop="questionsTypeName">
                      <el-input v-model="datadetail.questionsTypeName"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="排序" prop="questionsTypeSeq">
                      <el-input-number v-model="datadetail.questionsTypeSeq"></el-input-number>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="分数" prop="questionsTypeFraction">
                      <el-input-number v-model="datadetail.questionsTypeFraction"></el-input-number>
                    </el-form-item>
                  </el-col>
                </el-row>
  ...
  export default {
    ...
    methods: {
      async submitCreation() {
        const {
          data: res
        } = await this.$http.post("/manager/qtyp/add", this.datadetail)
        if (res.state !== 200) {
