<template>
  <div id="app">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: '/courselist' }">课件管理</el-breadcrumb-item>
      <el-breadcrumb-item :to="{ path: '/courseedit' }">编辑课件</el-breadcrumb-item>
    </el-breadcrumb>
          ...
          <el-container>
            <el-main>
              <el-form :model="coursedetail" :rules="rules" ref="coursedetail" label-width="100px"
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="课件名称" prop="coursewareNme">
                      <el-input v-model="coursedetail.coursewareNme"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="课件类型" prop="state">
                      <el-radio v-model="coursedetail.coursewareType" label="1">讲义</el-radio>
                      <el-radio v-model="coursedetail.coursewareType" label="2">文档</el-radio>
                      <el-radio v-model="coursedetail.coursewareType" label="3">视频</el-radio>
                      <el-radio v-model="coursedetail.coursewareType" label="4">标准</el-radio>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="课件时长" prop="coursewareHours">
                      <el-input v-model="coursedetail.coursewareHours"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="*组织机构" prop="organizationId">
                      <el-input @focus="showOp = true" suffix-icon="el-icon-search"

                       v-model="coursedetail.organizationName" :readonly="true"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="讲师" prop="teacherName">
                      <el-input v-model="coursedetail.teacherName" @focus="theacherDialog=true"
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="分类" prop="coursewareTypeId">
                      <el-input v-model="coursedetail.coursewareTypeName" @focus="typeDialog=true"
                        suffix-icon="el-icon-search" :readonly="true"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>

                <el-dialog title="分类" :visible.sync="typeDialog" class="protrusion">
                  <el-card class="box-card">
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="上传文件">
                      <el-upload :headers="myheader" :on-success="handleAvatarSuccess" class="avatar-uploader"
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="机构状态" prop="stutes">
                      <el-radio v-model="coursedetail.stutes" label="1">启用</el-radio>
                      <el-radio v-model="coursedetail.stutes" label="0">禁用</el-radio>
                    </el-form-item>
                  </el-col>
                </el-row>
