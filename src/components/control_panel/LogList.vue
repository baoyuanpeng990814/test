<template>
  <div id="app">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: '/loglist' }">日志查询</el-breadcrumb-item>
    ...
    <el-card class="list_card">
          ...
          <el-form class="demo-ruleForm login_form" label-width="auto">
            <el-col :span="11">
              <el-form-item label="时间段">
                <el-date-picker v-model="queryInfo.startTime" value-format="yyyy-MM-dd" type="date" placeholder="开始时间">
                </el-date-picker>
                <el-date-picker v-model="queryInfo.endTime" value-format="yyyy-MM-dd" type="date" placeholder="结束时间">
                </el-date-picker>
              </el-form-item>
            </el-col>
          ...
          <el-form class="demo-ruleForm login_form" label-width="auto">
            <el-col :span="5">
              <el-form-item label="操作类型">
                <el-input v-model="queryInfo.operationType" placeholder="操作类型"></el-input>
              </el-form-item>
            </el-col>

            <el-col :span="5">
              <el-form-item label="日志类型">
                <el-input v-model="queryInfo.logType" placeholder="日志类型"></el-input>
              </el-form-item>
            </el-col>
            
            <el-col :span="5">
              <el-form-item label="业务模块">
                <el-input v-model="queryInfo.businessModule" placeholder="业务模块"></el-input>
              </el-form-item>
            </el-col>
          </el-form>
        </el-row>
      ...
      <div>
        <el-table height=" calc(100vh - 400px) " ref="multipleTable" :data="tableData" tooltip-effect="dark"
          ...
          <el-table-column prop="businessModule" label="系统模块" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="logType" label="日志类型" show-overflow-tooltip>
          </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      async getLogList() {
        ...
        const {
          data: res
        } = await this.$http.post("/manager/log/list", this.queryInfo)
        if (res.state !== 200) {
