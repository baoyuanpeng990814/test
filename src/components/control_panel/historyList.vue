<template>
  <div id="app">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: '/Historylist' }"
        >学习归档</el-breadcrumb-item
      >
    </el-breadcrumb>
      ...
      <div slot="header" class="clearfix">
        <el-row class="buttons">
          ...
          <el-col :span="14" style="text-align: right;">
            <el-button @click="reset()" type="primary" class="resetBtn"
              >重置</el-button
            ></el-col
          >
        </el-row>
        ...
        <el-container>
          ...
          <el-main class="list_body">
            ...
            >
              ...
              >
                <template slot-scope="scope">{{
                  scope.row.createTime | showtiemDate
                }}</template>
              </el-table-column>
              <el-table-column
                prop="releaseStutes"
