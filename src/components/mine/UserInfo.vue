          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="账号" prop="userName">
                <el-input :readonly="true" v-model="datadetail.userName"></el-input>
              </el-form-item>
              ...
              <el-form-item label="身份证号" prop="cardId">
                <el-input :readonly="datadetail.cardId!=''" v-model="datadetail.cardId"></el-input>
              </el-form-item>
            ...
            <el-col :span="12">
              ...
              <el-form-item label="所属单位" prop="organizationName">
                <el-input :readonly="true" @focus="turnShowOp" v-model="datadetail.organizationName"></el-input>
              </el-form-item>

              <el-form-item label="入职时间" prop="cardId">
                <el-date-picker :readonly="datadetail.entryTime!=''" value-format="yyyy-MM-dd" type="date"
        ...
        <el-col class="upload_avatar" :span="4">
          ...
          <div>
            <el-upload class="avatar-uploader" :action="uploadUrl" :show-file-list="false"
              ...
              <img v-if="datadetail.userCover" :src="datadetail.userCover" class="avatar">
  ...
  export default {
    ...
    methods: {
      ...
      async modifyDetail() {
        ...
        const {
          data: res
        } = await this.$http.post("/learn/user/edit", this.datadetail)
        if (res.state !== 200) {
      ...
      async getInfo() {
        const {
          data: res
        } = await this.$http.get("/learn/user/info?id=" + this.$store.getters.userinfo.userId)
        if (res.state !== 200) {
          return this.$message.error(res.msg)
        } else {
