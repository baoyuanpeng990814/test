		...
		<div class="card_detail">
			<el-card>
				...
				<div class="edit_lines">
					<el-container>
						<el-main>
							<el-form :model="groupTreeDetail" :rules="rules" ref="groupTreeDetail" label-width="100px"
								class="demo-ruleForm login_form">
								<el-row>
									<el-col :span="24">
										<el-form-item label="标题" prop="groupingName">
											<el-input v-model="groupTreeDetail.groupingName"></el-input>
										</el-form-item>
									</el-col>
								</el-row>
								<el-row>
									<el-col :span="24">
										...
										<el-input v-model="groupTreeDetail.groupingExplain"></el-input>
										</el-form-item>
									</el-col>
								</el-row>
								...
								<el-row>
									<el-col :span="20" :offset="4">
										<el-button type="primary" @click="modifyDetail()">确定</el-button>
									</el-col>
								</el-row>
							</el-form>
						</el-main>
