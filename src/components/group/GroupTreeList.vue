      ...
      <div slot="header" class="clearfix">
        ...
        <el-row class="buttons">
          <el-col :span="24" :offset="0">
            ...
            <el-button icon="el-icon-plus" @click="addGroup()" type="primary">添加分组</el-button>
        ...
        <el-container>
          ...
          <el-main class="list_body">
            <el-table height=" calc(100vh - 350px) " ref="multipleTable" :data="tableData" tooltip-effect="dark"
              ...
              <el-table-column prop="groupingExplain" label="分组介绍" show-overflow-tooltip>
              </el-table-column>
              <el-table-column prop="userCount" label="分组人数" show-overflow-tooltip>
              </el-table-column>
              <el-table-column prop="updateUser" label="修改人" show-overflow-tooltip>
              </el-table-column>
              ...
              <el-table-column fixed="right" label="操作" width="240">
                <template slot-scope="scope">
                  ...
                  <el-button @click="addGroupUser(scope.row)" type="text" size="small">添加成员</el-button>
                  <!-- 查看-->
                  <el-button @click="groupList(scope.row)" type="text" size="small">查看成员</el-button>
                  <!-- -->
                </template>
              </el-table-column>
            </el-table>
